...
const CACHE_VERSION = 'v49'; // v49: rollover propio del % automatico del lote. v48: lote con regalo — % AUTOMATICO en la carga (primera/todas + franja horaria) + audiencia por segmento
